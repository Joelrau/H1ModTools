...
makeType( destructibleType ) 
{
	...
	switch( destructibleType )
	{
		...
		case "prop_ac_prs_enm_barge_a_1":
			prop_ac_prs_enm_barge_a( 1 );
			break;
		case "prop_ac_prs_enm_barge_a_2":
			prop_ac_prs_enm_barge_a( 2 );
			break;
	    ...
	    case "prop_ac_prs_fps_hc_extc_balcony_a1":
	    	prop_ac_prs_fps_hc_extc_balcony( "a", 1 );
	        //prop_ac_prs_fps_hc_extc_balcony_a1();
	        break;
	    case "prop_ac_prs_fps_hc_extc_balcony_a2":
	    	prop_ac_prs_fps_hc_extc_balcony( "a", 2 );
	        //prop_ac_prs_fps_hc_extc_balcony_a2();
	        break;
	    case "prop_ac_prs_fps_hc_extc_balcony_a3":
	    	prop_ac_prs_fps_hc_extc_balcony( "a", 3 );
	        //prop_ac_prs_fps_hc_extc_balcony_a3();
	        break;
	    case "prop_ac_prs_fps_hc_extc_balcony_b1":
	    	prop_ac_prs_fps_hc_extc_balcony( "b", 1 );
	        //prop_ac_prs_fps_hc_extc_balcony_b1();
	        break;
	    case "prop_ac_prs_fps_hc_extc_balcony_b2":
	    	prop_ac_prs_fps_hc_extc_balcony( "b", 2 );
	        //prop_ac_prs_fps_hc_extc_balcony_b2();
	        break;
	    case "prop_ac_prs_fps_hc_extc_balcony_b3":
	    	prop_ac_prs_fps_hc_extc_balcony( "b", 3 );
	        //prop_ac_prs_fps_hc_extc_balcony_b3();
	        break;
	    case "prop_ac_prs_fps_hc_extc_balcony_c1":
	    	prop_ac_prs_fps_hc_extc_balcony( "c", 1 );
	        //prop_ac_prs_fps_hc_extc_balcony_c1();
	        break;
	    case "prop_ac_prs_fps_hc_extc_balcony_c2":
	    	prop_ac_prs_fps_hc_extc_balcony( "c", 2 );
	        //prop_ac_prs_fps_hc_extc_balcony_c2();
	        break;
	    case "prop_ac_prs_fps_hc_extc_column_b_a1":
	    	prop_ac_prs_fps_hc_extc_column( "b", "a", 1 );
	        //prop_ac_prs_fps_hc_extc_column_b_a1();
	        break;
	    case "prop_ac_prs_fps_hc_extc_column_b_a2":
	    	prop_ac_prs_fps_hc_extc_column( "b", "a", 2 );
	        //prop_ac_prs_fps_hc_extc_column_b_a2();
	        break;
	    case "prop_ac_prs_fps_hc_extc_column_b_a3":
	    	prop_ac_prs_fps_hc_extc_column( "b", "a", 3 );
	        //prop_ac_prs_fps_hc_extc_column_b_a3();
	        break;
	    case "prop_ac_prs_fps_hc_extc_column_t_a1":
	    	prop_ac_prs_fps_hc_extc_column( "t", "a", 1 );
	        //prop_ac_prs_fps_hc_extc_column_t_a1();
	        break;
	    case "prop_ac_prs_fps_hc_extc_column_t_a2":
	    	prop_ac_prs_fps_hc_extc_column( "t", "a", 2 );
	        //prop_ac_prs_fps_hc_extc_column_t_a2();
	        break;
	    case "prop_ac_prs_fps_hc_extc_column_t_a3":
	    	prop_ac_prs_fps_hc_extc_column( "t", "a", 3 );
	        //prop_ac_prs_fps_hc_extc_column_t_a3();
	        break;
	   	case "prop_ac_prs_enm_missile_boat_a":
	        prop_ac_prs_enm_missile_boat_a();
	        break;
	    case "prop_bv_prp_mvillage_tstore_a":
	        prop_bv_prp_mvillage_tstore_a();
	        break;
	    case "prop_bv_prp_mvillage_tstore_b":
	        prop_bv_prp_mvillage_tstore_b();
	        break;
	    case "prop_bv_prp_mvillage_tstore_c":
	        prop_bv_prp_mvillage_tstore_c();
	        break;
	    case "prop_bv_prp_mvillage_tstore_d":
	        prop_bv_prp_mvillage_tstore_d();
	        break;
	    case "prop_bv_prp_mvillage_church_a1":
	        prop_bv_prp_mvillage_church_a1();
	        break;
	    case "prop_bv_prp_mvillage_church_a2":
	        prop_bv_prp_mvillage_church_a2();
	        break;
	    case "prop_bv_prp_mvillage_church_a3":
	        prop_bv_prp_mvillage_church_a3();
	        break;
	    case "prop_bv_prp_mvillage_church_a4":
	        prop_bv_prp_mvillage_church_a4();
	        break;
	    case "prop_bv_prp_mvillage_church_a5":
	        prop_bv_prp_mvillage_church_a5();
	        break;
	    case "prop_bv_prp_mvillage_tudorg_a1":
	        prop_bv_prp_mvillage_tudorg_a1();
	        break;
	    case "prop_bv_prp_mvillage_tudorg_a2":
	        prop_bv_prp_mvillage_tudorg_a2();
	        break;
	    case "prop_bv_prp_mvillage_tudorg_a3":
	        prop_bv_prp_mvillage_tudorg_a3();
	        break;
	    case "prop_bv_prp_mvillage_tudor_a":
	        prop_bv_prp_mvillage_tudor_a();
	        break;
	    case "prop_bv_prp_mvillage_grand_house_a":
	        prop_bv_prp_mvillage_grand_house_a();
	        break;
	    case "prop_bv_prp_mvillage_grand_house_a1":
	        prop_bv_prp_mvillage_grand_house_a1();
	        break;
	    case "prop_bv_prp_mvillage_grand_house_a2":
	        prop_bv_prp_mvillage_grand_house_a2();
	        break;
	    case "prop_bv_prp_mvillage_hse_a":
	        prop_bv_prp_mvillage_hse_a();
	        break;
	    case "prop_bv_prp_mvillage_pub_a":
	        prop_bv_prp_mvillage_pub_a();
	        break;
	    case "prop_bv_prp_mvillage_pub_a1":
	        prop_bv_prp_mvillage_pub_a1();
	        break;
	    case "prop_bv_prp_mvillage_thatch_cottage_a":
	        prop_bv_prp_mvillage_thatch_cottage_a();
	        break;
	    case "prop_bv_prp_mvillage_thatch_cottage_a1":
	        prop_bv_prp_mvillage_thatch_cottage_a1();
	        break;
	    case "prop_bv_prp_mvillage_thatch_cottage_b":
	        prop_bv_prp_mvillage_thatch_cottage_b();
	        break;
		...
		case "vehicle_hummer":
			...
			break;
		case "vehicle_bw_hummer":
			vehicle_bw_hummer( destructibleType );
			break;
		case "vehicle_gaz":
		...
		case "vehicle_moving_truck_thai":
			...
			break;
		case "vehicle_moving_truck_tham":
			vehicle_moving_truck( destructibleType );
		...
		case "toy_security_camera":
			...
			break;
		case "toy_security_camera_down":
			toy_security_camera2( destructibleType, "security_camera_idle_down" );
			break;
		case "toy_security_camera_l_down":
			toy_security_camera2( destructibleType, "security_camera_idle_l_down" );
			break;
		case "toy_security_camera_still":
			toy_security_camera2( destructibleType, "security_camera_null" );
			break;
		case "toy_security_camera_still_l_down":
			toy_security_camera2( destructibleType, "security_camera_null_l_down" );
			break;
		case "toy_security_camera_still_r_down":
			toy_security_camera2( destructibleType, "security_camera_null_r_down" );
			break;
		...
		case "satellite_dish_big_destructible":
			...
			break;
		case "vehicle_truck_dually_black":
		case "vehicle_truck_dually_blue": 
		case "moab_truck_dually_blue":
		case "vehicle_truck_dually_red":
		case "vehicle_truck_dually_white":
		case "vehicle_truck_heavyduty_black":
		case "vehicle_truck_heavyduty_blue":
		case "vehicle_truck_heavyduty_red":
		case "vehicle_truck_heavyduty_white":
			vehicle_truck( destructibleType );
			break;
		//*Raven
		...
		case "vehicle_jeep_dusty":
			...
			break;
		case "toy_old_wood_barrel_01":
			toy_old_wood_barrels( "barrel_01", "barrel_01_dest", "bottom" );
			break;
		case "toy_old_wood_barrel_02":
			toy_old_wood_barrels( "barrel_02", "barrel_02_dest", "bottom" );
			break;
		case "toy_old_wood_tall_barrel_01":
			toy_old_wood_barrels( "tall_barrel_01", "tall_barrel_01_dest", "tall_bottom" );
			break;
		case "toy_old_wood_tall_barrel_02":
			toy_old_wood_barrels( "tall_barrel_02", "tall_barrel_02_dest", "tall_bottom" );
			break;
		case "toy_terracotta_pot_a_white_dest":
			toy_terracotta_pot( destructibleType, "a_white" );
			break;
		case "toy_terracotta_pot_a_violet_dest":
			toy_terracotta_pot( destructibleType, "a_violet" );
			break;
		case "toy_terracotta_pot_b_yellow_dest":
			toy_terracotta_pot( destructibleType, "b_yellow" );
			break;
		case "toy_terracotta_pot_b_red_dest":
			toy_terracotta_pot( destructibleType, "b_red" );
			break;
		case "toy_furniture_coffee_table_modern_01":
			toy_furniture_coffee_table_modern( destructibleType, "1", 55 );
			break;
		case "toy_furniture_coffee_table_modern_02":
			toy_furniture_coffee_table_modern( destructibleType, "2", 60 );
			break;
...
prop_ac_prs_enm_barge_a( number )
{
	destructible_create( "prop_ac_prs_enm_barge_a_" + number, "tag_origin", 250, undefined, 32, "no_melee" );
			destructible_state( "tag_origin", "ac_prs_enm_barge_a_" + number + "_dam_animated", 250, undefined, 32, "no_melee" );
...
prop_ac_prs_enm_storage_bld( type, number )
{
	end = "";	
	if ( IsDefined( number ) )
		end = "_" + number;
	destructible_create( "prop_ac_prs_enm_storage_bld_" + type + end, "p_ac_prs_enm_storage_bld_" + type + end, 250, undefined, 32, "no_melee" );
			destructible_state( "p_ac_prs_enm_storage_bld_" + type + end + "_dam", "ac_prs_enm_storage_bld_" + type + end + "_dam", 250, undefined, 32, "no_melee" );
				destructible_fx( undefined, "explosions/building_explosion_paris_ac130", false );
				end_fx = "a";
				switch ( type )
				{
				...
				destructible_fx( undefined, "explosions/ac_prs_fx_flir_debris_explosion_" + end_fx, false );			
}

prop_ac_prs_enm_tent( type )
{
	destructible_create( "prop_ac_prs_enm_tent_" + type, "ac_prs_enm_tent_" + type + "_lod0", 250, undefined, 32, "no_melee" );
			tag = "ac_prs_enm_tent_" + type + "_lod1";
			switch ( type )
			{
				case "a":
					tag = "polySurface1";
			...
			destructible_state( tag, "ac_prs_enm_tent_" + type + "_dam1", 250, undefined, 32, "no_melee" );
...
prop_ac_prs_enm_cargo_crate_a( number )
{
	destructible_create( "prop_ac_prs_enm_cargo_crate_a_" + number, "ac_prs_enm_cargo_crate_a_" + number + "_lod0", 250, undefined, 32, "no_melee" );
			destructible_state( "ac_prs_enm_cargo_crate_a_" + number + "_lod0", "ac_prs_enm_cargo_crate_a_" + number + "_dam", 250, undefined, 32, "no_melee" );
				destructible_fx( undefined, "explosions/building_explosion_paris_ac130", false );				
				destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_ac_prs_enm_crates( type, number )
{
	destructible_create( "prop_ac_prs_enm_crates_" + type + "_" + number, "ac_prs_enm_crates_" + type + "_" + number + "_lod0", 250, undefined, 32, "no_melee" );
			destructible_state( "ac_prs_enm_crates_" + type + "_" + number + "_dam_lod0", "ac_prs_enm_crates_" + type + "_" + number + "_dam", 250, undefined, 32, "no_melee" );
				destructible_fx( undefined, "explosions/ac_prs_fx_enm_crates_" + type + "_explosion_1", false );				
}
...
prop_ac_prs_fps_hc_extc_balcony( type, number )
{
	destructible_create( "prop_ac_prs_fps_hc_extc_balcony_" + type + number, "ac_prs_fps_hc_extc_balcony_" + type + "_lod0", 80, undefined, 32, "no_melee" );
			destructible_state( "ac_prs_fps_hc_extc_balcony_" + type + "_dam" + number + "_lod0", "ac_prs_fps_hc_extc_balcony_" + type + "_dam" + number, 250, undefined, 32, "no_melee" );
				destructible_fx( undefined, "explosions/ac_prs_fx_dust_explosion_a", false );
				fx = "explosions/ac_prs_fps_extc_balcony_a_explosion_1";
				switch( type )
				{
					case "b":
						fx = "explosions/ac_prs_fps_extc_balcony_b_explosion_1";
						break;
					case "c":
						fx = "explosions/ac_prs_fps_extc_balcony_c_explosion_" + number;
						break;
				}
				destructible_fx( undefined, fx, false );
}

prop_ac_prs_fps_hc_extc_column( type1, type2, number )
{
	destructible_create( "prop_ac_prs_fps_hc_extc_column_" + type1 + "_" + type2 + number, "ac_prs_fps_hc_extc_column_" + type1 + "_" + type2 + "_lod0", 80, undefined, 32, "no_melee" );
			destructible_state( "ac_prs_fps_hc_extc_column_" + type1 + "_" + type2 + "_dam" + number + "_lod0", "ac_prs_fps_hc_extc_column_" + type1 + "_" + type2 + "_dam" + number, 250, undefined, 32, "no_melee" );
				destructible_fx( undefined, "explosions/ac_prs_fx_dust_explosion_a", false );
...
prop_bv_prp_mvillage_tstore_a()
{
	destructible_create( "prop_bv_prp_mvillage_tstore_a", "bv_prp_mvillage_tstore_a_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_tstore_a_dam_lod0", "bv_prp_mvillage_tstore_a_dam", 250, undefined, 32, "no_melee" );
			//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_tstore_b()
{
	destructible_create( "prop_bv_prp_mvillage_tstore_b", "bv_prp_mvillage_tstore_b_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_tstore_b_dam_lod0", "bv_prp_mvillage_tstore_b_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_tstore_c()
{
	destructible_create( "prop_bv_prp_mvillage_tstore_c", "bv_prp_mvillage_tstore_c_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_tstore_c_dam_lod0", "bv_prp_mvillage_tstore_c_dam", 250, undefined, 32, "no_melee" );
			//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_tstore_d()
{
	destructible_create( "prop_bv_prp_mvillage_tstore_d", "bv_prp_mvillage_tstore_d_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_tstore_d_dam_lod0", "bv_prp_mvillage_tstore_d_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_church_a1()
{
	destructible_create( "prop_bv_prp_mvillage_church_a1", "bv_prp_mvillage_church_a1_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_church_a1_dam_lod0", "bv_prp_mvillage_church_a1_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_church_a2()
{
	destructible_create( "prop_bv_prp_mvillage_church_a2", "bv_prp_mvillage_church_a2_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_church_a2_dam_lod0", "bv_prp_mvillage_church_a2_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_church_a3()
{
	destructible_create( "prop_bv_prp_mvillage_church_a3", "bv_prp_mvillage_church_a3_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_church_a3_dam_lod0", "bv_prp_mvillage_church_a3_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_church_a4()
{
	destructible_create( "prop_bv_prp_mvillage_church_a4", "bv_prp_mvillage_church_a4_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_church_a4_dam_lod0", "bv_prp_mvillage_church_a4_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_church_a5()
{
	destructible_create( "prop_bv_prp_mvillage_church_a5", "bv_prp_mvillage_church_a5_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_church_a5_dam_lod0", "bv_prp_mvillage_church_a5_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_tudorg_a1()
{
	destructible_create( "prop_bv_prp_mvillage_tudorg_a1", "bv_prp_mvillage_tudorg_a1_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_tudorg_a1_dam_lod0", "bv_prp_mvillage_tudorg_a1_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_tudorg_a2()
{
	destructible_create( "prop_bv_prp_mvillage_tudorg_a2", "bv_prp_mvillage_tudorg_a2_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_tudorg_a2_dam_lod0", "bv_prp_mvillage_tudorg_a2_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_tudorg_a3()
{
	destructible_create( "prop_bv_prp_mvillage_tudorg_a3", "bv_prp_mvillage_tudorg_a3_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_tudorg_a3_dam_lod0", "bv_prp_mvillage_tudorg_a3_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_tudor_a()
{
	destructible_create( "prop_bv_prp_mvillage_tudor_a", "bv_prp_mvillage_tudor_a_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_tudor_a_dam_lod0", "bv_prp_mvillage_tudor_a_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}
             
prop_bv_prp_mvillage_grand_house_a()
{
	destructible_create( "prop_bv_prp_mvillage_grand_house_a", "bv_prp_mvillage_grand_house_a_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_grand_house_a_dam_lod0", "bv_prp_mvillage_grand_house_a_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_grand_house_a1()
{
	destructible_create( "prop_bv_prp_mvillage_grand_house_a1", "bv_prp_mvillage_grand_house_a1_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_grand_house_a1_dam_lod0", "bv_prp_mvillage_grand_house_a1_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_grand_house_a2()
{
	destructible_create( "prop_bv_prp_mvillage_grand_house_a2", "bv_prp_mvillage_grand_house_a2_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_grand_house_a2_dam_lod0", "bv_prp_mvillage_grand_house_a2_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_hse_a()
{
	destructible_create( "prop_bv_prp_mvillage_hse_a", "bv_prp_mvillage_hse_a_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_hse_a_dam_lod0", "bv_prp_mvillage_hse_a_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}

prop_bv_prp_mvillage_pub_a()
{
	destructible_create( "prop_bv_prp_mvillage_pub_a", "bv_prp_mvillage_pub_a_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_pub_a_dam_lod0", "bv_prp_mvillage_pub_a_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}           

prop_bv_prp_mvillage_pub_a1()
{
	destructible_create( "prop_bv_prp_mvillage_pub_a1", "bv_prp_mvillage_pub_a1_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_pub_a1_dam_lod0", "bv_prp_mvillage_pub_a1_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}           

prop_bv_prp_mvillage_thatch_cottage_a()
{
	destructible_create( "prop_bv_prp_mvillage_thatch_cottage_a", "bv_prp_mvillage_thatch_cottage_a_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_thatch_cottage_a_dam_lod0", "bv_prp_mvillage_thatch_cottage_a_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}         

prop_bv_prp_mvillage_thatch_cottage_a1()
{
	destructible_create( "prop_bv_prp_mvillage_thatch_cottage_a1", "bv_prp_mvillage_thatch_cottage_a1_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_thatch_cottage_a1_dam_lod0", "bv_prp_mvillage_thatch_cottage_a1_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}         

prop_bv_prp_mvillage_thatch_cottage_b()
{
	destructible_create( "prop_bv_prp_mvillage_thatch_cottage_b", "bv_prp_mvillage_thatch_cottage_b_lod0", 250, undefined, 32, "no_melee" );
			destructible_fx( undefined, "dust/scaffolding_dust_wood_debris_lg", false );
			destructible_state( "bv_prp_mvillage_thatch_cottage_b_dam_lod0", "bv_prp_mvillage_thatch_cottage_b_dam", 250, undefined, 32, "no_melee" );				
				//destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
}         
#using_animtree( "destructibles" );
...
toy_chicken_dlc()
{
	...
	// Chicken
	//---------------------------------------------------------------------
	destructible_create( "toy_chicken_dlc", "tag_origin", 0, undefined, 32 );
			toy_chicken_dlc_idle();
			destructible_loopsound( "animal_chicken_idle_loop" );
		destructible_state( "tag_origin", "chicken", 25 );
			destructible_fx( "tag_origin", "props/chicken_exp");
			destructible_anim( get_precached_anim( "chicken_cage_death" ), #animtree, "setanimknob", undefined, 0, "chicken_cage_death" );
			destructible_anim( get_precached_anim( "chicken_cage_death_02" ), #animtree, "setanimknob", undefined, 1, "chicken_cage_death_02" );
			destructible_sound( "animal_chicken_death" );
		destructible_state( undefined, "chicken", undefined, undefined, "no_melee" ); 
}

#using_animtree( "chicken" );
toy_chicken_dlc_idle()
{
			destructible_anim( get_precached_anim( "Chicken_cage_pecking_idle" ), #animtree, "setanimknob", undefined, 0, "Chicken_cage_pecking_idle", 1.6 );
			destructible_anim( get_precached_anim( "Chicken_cage_seated_idle" ), #animtree, "setanimknob", undefined, 1, "Chicken_cage_seated_idle", 1.6 );	
}
...
vehicle_london_cab_black()
{
	...
	*/
	destructible_create( "vehicle_london_cab_black" , "tag_body", 250, undefined, 32, "no_melee" );
		//destructible_splash_damage_scaler( 18 );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
			destructible_state( undefined, undefined, 200, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_blacksmoke", 0.4 );
	...
	destructible_create( destructibleType, "tag_body", 400, undefined, 32, "no_melee" );
		//destructible_splash_damage_scaler( 18 );
			...
			destructible_state( undefined, undefined, 400, undefined, 32, "no_melee" );
				...
				destructible_explode( 4000, 5000, 210, 250, 50, 300, undefined, undefined, 0.3, 500 );
				destructible_anim( %vehicle_80s_sedan1_destroy, #animtree, "setanimknob", undefined, undefined, "vehicle_80s_sedan1_destroy" );
			destructible_state( undefined, "vehicle_bw_hummer_destroyed", undefined, 32, "no_melee" );
		// Tires
		destructible_part( "left_wheel_01_jnt", undefined, 20, undefined, undefined, "no_melee" );
			destructible_anim( %vehicle_80s_sedan1_flattire_LF, #animtree, "setanim" );
			destructible_sound( "veh_tire_deflate", "bullet" );
...
vehicle_moving_truck( destructibleType )
{
	...
	destructible_create( destructibleType, "tag_body", 300, undefined, 32, "no_melee" );
		//destructible_splash_damage_scaler( 18 );
			...
			else if( destructibleType == "vehicle_moving_truck_tham" )
				destructible_state( undefined, "vehicle_moving_truck_tham_dst", undefined, 32, "no_melee" );
			else
...
vehicle_van_iw5_gas( basemodel )
{
  ...
  TAG_WHEEL_FRONT_RIGHT
	...
	*/
	...
	destructible_create( basemodel + "_destructable_gas", "tag_body", 250, undefined, 32, "no_melee" );
		//destructible_splash_damage_scaler( 18 );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_whitesmoke", 0.4 );
			destructible_state( undefined, undefined, 200, undefined, 32, "no_melee" );
				destructible_loopfx( "tag_hood_fx", "smoke/car_damage_blacksmoke", 0.4 );
			...
			destructible_state( undefined, undefined, 300, "player_only", 32, "no_melee" );
				destructible_loopsound( "fire_vehicle_med" );
			destructible_state( undefined, undefined, 400, undefined, 32, "no_melee" );
				destructible_fx( "tag_origin", "explosions/vehicle_explosion_medium", false );
				destructible_fx( "TAG_DEATH_FX", "smoke/poison_gas_mp_truck", false );
				/*
				destructible_createDOT_predefined( 1 );
					destructible_setDOT_onTick( 0, 1, 20, 1, 1, 0, "poison", "player" );
				*/
				/*
				destructible_createDOT_predefined( 1 );
					destructible_buildDOT_onTick( 20, "player" );
						destructible_buildDOT_startLoop( 0 );
							destructible_buildDOT_damage( 1, 1, 0, 0, "MOD_SUICIDE", "claymore_mp" );
							destructible_buildDOT_wait( 1 );
				*/
				destructible_createDOT_radius( "tag_death_fx", 0, 220, 92 );
					destructible_setDOT_onTick( 0, 1, 20, 0, 200, 0, "poison", "player" );
				/*
				destructible_createDOT_radius( "tag_death_fx", 0, 220, 92 );
					destructible_buildDOT_onTick( 20, "player" );
						destructible_buildDOT_startLoop( 0 );
							destructible_buildDOT_damage( 50, 50, 0, 0, "MOD_SUICIDE", "claymore_mp" );
							destructible_buildDOT_wait( 1 );
				*/
				destructible_sound( "car_explode" );
				destructible_explode( 4000, 5000, 200, 250, 50, 300, undefined, undefined, 0.3, 500 );
...
vehicle_truck( destructibleType )
{
	destructible_create( destructibleType, "tag_body", 250, undefined, 32, "no_melee" );
			...
			destructible_state( undefined, undefined, 400, undefined, 32, "no_melee" );
				...
				destructible_explode( 4000, 5000, 150, 250, 50, 300, undefined, undefined, 0.3, 500 );
				destructible_anim( %vehicle_80s_sedan1_destroy, #animtree, "setanimknob", undefined, undefined, "vehicle_80s_sedan1_destroy" );
			destructible_state( undefined, destructibleType + "_destroyed", undefined, 32, "no_melee" );
		// Tires
		destructible_part( "left_wheel_01_jnt", undefined, 20, undefined, undefined, "no_melee" );
			destructible_anim( %vehicle_80s_sedan1_flattire_LF, #animtree, "setanim" );
			destructible_sound( "veh_tire_deflate", "bullet" );
...
toy_security_camera2( destructibleType, idleAnimation )
{
	//---------------------------------------------------------------------
	// Rotating security camera, updated with alternate idle animations for scanning in different directions.
	// NB This was added for MW3 DLC & should be merged into the old security camera once we get into the IW6 tree.
	//---------------------------------------------------------------------
	
	destructible_create( destructibleType, "tag_camera_tilt", 0, undefined, 32 );
			destructible_anim( get_precached_anim( idleAnimation ), #animtree, "setanimknob", undefined, undefined, idleAnimation );
...
toy_old_wood_barrels( barrel_variant, effect_variant, bottom_version )
{
	//---------------------------------------------------------------------
	// toy_old_wood_barrel variants
	//---------------------------------------------------------------------
	destructible_create( "toy_old_wood_" + barrel_variant, "tag_origin", 120, undefined, 32, "splash" );
				destructible_fx( "tag_origin", "props/old_wood_" + effect_variant, true, undefined );
				destructible_sound( "exp_old_wood_barrel" );															 
				destructible_explode( 600, 651, 1, 1, 10, 20 );	 // force_min, force_max, rangeSP, rangeMP, mindamage, maxdamage
				
		destructible_state( undefined, "old_wood_barrel_dmg_" + bottom_version, undefined, undefined, undefined, undefined, undefined, false );
}


toy_terracotta_pot( destructibleType, effect_variant )
{
	//---------------------------------------------------------------------
	// toy_terracotta_pot variants
	//---------------------------------------------------------------------
	destructible_create( destructibleType, "tag_origin", 50, undefined, 32, "no_melee" );
				destructible_fx( "tag_origin", "props/prop_terracotta_pot_" + effect_variant + "_dest", true, undefined );
				destructible_explode( 600, 651, 1, 1, 10, 20 );	 // force_min, force_max, rangeSP, rangeMP, mindamage, maxdamage
				
		destructible_state( undefined, "prop_terracotta_null_mesh", undefined, undefined, undefined, undefined, undefined, false );
}
...
rus_vx_gas_canister( destructibleType )
{
	destructible_create( destructibleType, "tag_origin", 250, undefined, 32, "no_melee" );
		destructible_state( "tag_origin", "rus_vx_gas_canister_destroyed", 250, undefined, 32, "no_melee" );
			...
			destructible_explode( 7000, 8000, 150, 256, 16, 150, undefined );
}


			
toy_furniture_coffee_table_modern( destructibleType, model_variant, splodeRadius )
{
	//---------------------------------------------------------------------
	// toy_furniture_coffee_table_modern variants
	//---------------------------------------------------------------------
	destructible_create( destructibleType, "tag_origin", 50, undefined, 32, "no_melee" );
				destructible_fx( "tag_fx", "props/furniture_coffee_table_modern_0" + model_variant, true, undefined );
				...
				destructible_explode( 600, 1651, splodeRadius, splodeRadius, 10, 20, undefined, 10 );	 // force_min, force_max, rangeSP, rangeMP, mindamage, maxdamage
				
		destructible_state( undefined, "furniture_coffee_table_modern_0" + model_variant + "_dest", undefined, undefined, undefined, undefined, undefined, false );
}
